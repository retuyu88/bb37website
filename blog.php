<?php
   ...
   include('koneksi.php');
    ...
    $q = "SELECT artikel.kd_artikel, artikel.kategori, artikel.judul,artikel.isi,artikel.tanggal,artikel.gambar,user.nama
        ...
        WHERE artikel.kd_artikel like '$search' or
              artikel.kategori like '$search' or
              artikel.judul like 'ssearch' or
              artikel.isi like '$search' or 
              artikel.tanggal like '$search' or 
              artikel.gambar like '$search' or 
                            ...
                            <div class="collapse navbar-collapse justify-content-end" id="mosh-navbar">
                                ...
                                <div class="search-form-area animated">
                                    <form action="blog.php" method="post">
                                        <input type="search" name="search" id="search" placeholder="Ketikan Artikel yang ingin anda cari lalu tekan enter">
                            ...
                            <div class="col-12">
                                <div class="single-blog wow fadeInUp" data-wow-delay="0.2s">
                                    ...
                                    <?php while($row = mysqli_fetch_array($artikel,MYSQLI_ASSOC)): ?>                            
                                        <br>
                                        <a href="blog.php?search=<?php echo $row['kategori'];?>" ><?php echo $row['kategori'];?></a>
                                        <hr>
                                        <!-- Post Title -->
                                        <h1><a href="artikel.php?kd_artikel=<?php echo $row['kd_artikel']?>" ><?php echo $row['judul'];?></a></h1>
                                        ...
                                        <div class="post-meta">
                                            ...
                                            ?>
                                            <h6 align="RIGHT"><a href="blog.php?search=<?php echo $row['tanggal'];?>"><?php echo $strwaktu;?></a></h6>
                                            <h6>By <a href="blog.php?search=<?php echo $row['nama'];?>"><?php echo $row['nama'];?></a></h6>
                                        </div>
                                        <!-- Post Title -->
                                        <!-- Post Excerpt -->
