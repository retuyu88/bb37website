<?php
   ...
   $kd_artikel= $_GET['kd_artikel'];
    ...
    $nama = $rc['nama'];
    $tanggal = $rc['tanggal'];
    $q2 = "SELECT artikel.kd_artikel, artikel.kategori, artikel.judul,artikel.isi,artikel.tanggal,user.nama
        FROM artikel
        INNER JOIN user
        ON (user.kd_user = artikel.kd_user)
    ...
    $q3 = "SELECT artikel.kd_artikel, artikel.kategori, artikel.judul,artikel.isi,artikel.tanggal,user.nama
        FROM artikel
        INNER JOIN user
        ON (user.kd_user = artikel.kd_user)
                            ...
                            <div class="col-12">
                                <div class="single-blog wow fadeInUp" data-wow-delay="0.2s">
                                    <!-- Post Category -->                         
                                        ...
                                        <!-- Post Meta -->
                                        <div class="post-meta">
                                            <h6>By <a href="#"><?php echo $nama;?>,</a><a href="#"><?php echo $tanggal;?></a></h6>
                                        </div>
                                        <!-- Post Title -->
                                        <!-- Post Excerpt -->
                                        <p><?php echo $isi;?></p>
